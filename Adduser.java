...
public class Adduser extends JFrame { // The Add user class inputs the user information into the database
	...
	//Initialize insert in to Insert info
	Insertinfo insertin;
	//Initialize get in to Get info
	Getinfo getin;
